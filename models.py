...
class BlogPost(models.Model):
	...
	readgrp = models.ManyToManyField('zlogin_models.UserGroup',blank=True,null=True,related_name="pichublog_readgrp")
	readuin = models.ManyToManyField('zlogin_models.User',blank=True,null=True,related_name="pichublog_readuin")
	readuex = models.ManyToManyField('zlogin_models.User',blank=True,null=True,related_name="pichublog_readuex")
	freecomment = models.BooleanField(default=True)
	commentgrp = models.ManyToManyField('zlogin_models.UserGroup',blank=True,null=True,related_name="pichublog_commentgrp")
	commentuin = models.ManyToManyField('zlogin_models.User',blank=True,null=True,related_name="pichublog_commentuin")
	commentuex = models.ManyToManyField('zlogin_models.User',blank=True,null=True,related_name="pichublog_commentuex")
